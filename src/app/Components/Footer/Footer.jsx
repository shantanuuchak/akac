            ...
            <div className="container">
              <div className="cs_footer_top_in">
                <div className="cs_social_btns cs_style_1">
                  ...
                  <Link href="https://instagram.com/akacindia" className="cs_social_btn cs_center">
                ...
                <div className="cs_footer_contact_card">
                  ...
                  <div>
                    ...
                    <h3 className="mb-0 cs_fs_24 cs_semibold cs_white_color"><a href="tel:+917715864243">+91 77158 64243</a></h3>
                  </div>
                </div>
              </div>
            </div>
