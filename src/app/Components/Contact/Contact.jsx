          ...
          <div className="row cs_gap_y_50">
            <div className="col-xxl-6 col-lg-7">
              ...
              <p className="cs_mb_30">
                Experience unparalleled comfort with AKAC&apos;s QuickCool AC
                Installation service. Our certified technicians ensure fast,
                efficient, and safe installation of your new air conditioning
                system, tailored to your specific needs. Trust AKAC for a
                seamless, cool experience from start to finish.
              </p>
              ...
              <p className="cs_mb_20">
                Ensure your AC system is ready for the hottest days with our
                Comfort Check Tune-Up
              </p>
